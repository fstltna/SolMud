...
*/
public class Prayer_Infidelity extends Prayer
{
	@Override
	public String ID()
	{
		return "Prayer_Infidelity";
	}

	private final static String localizedName = CMLib.lang().L("Infidelity");
	...
	private final static String localizedStaticDisplay = CMLib.lang().L("(Infidelity)");
	...
	public void unInvoke()
	{
		...
		if(canBeUninvoked())
			mob.tell(L("Your magical infidelity subsides."));
	}
	...
	public boolean okMessage(final Environmental myHost, final CMMsg msg)
	{
		...
		if(msg.target() instanceof MOB)
		{
			...
			{
				myChar.tell(L("You infidelity geas prevents you from doing that."));
				return false;
			}
		}
		return true;
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(success)
		{
			...
			if(mob.location().okMessage(mob,msg))
			{
				...
				mob.location().show(target,null,CMMsg.MSG_OK_VISUAL,L("<S-NAME> gain(s) the infidelity geas!"));
