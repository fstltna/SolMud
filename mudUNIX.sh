...
/usr/lib/jvm/jdk-12.0.1/bin/java -classpath ".:./lib/js.jar:./lib/jzlib.jar:./lib/mysql-connector-java-5.1.46-bin.jar" -Xms129m -Xmx256m com.planet_ink.coffee_mud.application.MUD "Secret of Life"
